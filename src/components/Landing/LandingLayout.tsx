...
const LandingLayout = () => {
    return (
        <div className="w-full h-svh max-md:h-max bg-pink-100/50 text-gray-700 overflow-x-hidden relative flex flex-col">
            ...
            <div className="flex max-md:flex-col flex-row-reverse h-full max-md:mt-24 min-h-full items-center justify-center">
                ...
                <div className="ml-16 max-md:ml-0 justify-center flex flex-col z-10 gap-4 max-md:w-[calc(100%-8rem)] mb-16">
            ...
            <div className="hidden lg:flex absolute w-[calc(100%-8rem)] left-1/2 -translate-x-1/2 bottom-8 rounded-xl border border-zinc-800/50 ps-16 pe-8 py-6 bg-zinc-800  text-slate-100 items-center max-md:flex-col max-md:p-8 max-md:relative max-md:translate-y-0">
